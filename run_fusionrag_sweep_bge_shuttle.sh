...
RESULT_DIR="/home/shm/document/exp/FusionRAG/result/BGE_SHUFFLED3"       # 结果保存目录（CSV等）
...
RECALL_METHOD="BGE_SHUFFLED"       # 召回方法: bge, random, repeat_self, fixed_doc,BGE_SHUFFLED,RANDOM_TEXT
