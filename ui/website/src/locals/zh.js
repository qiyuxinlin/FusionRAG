...
export default {
    home: {
        ...
        today: '今天',
        previous:'历史',
        withoutAssistantTip:'本记录的Madsys已被删除，用户只能查看历史对话信息而无法继续对话!',
        deleteThreadTip:'删除记录会清除历史信息哦～'
    },
    chat:{
        inputTip:"发送信息和 Madsys 畅聊吧～",
    },
    explore:{
        description: "基于Lexllama，一起来创建你的专属Madsys吧~",
        configuring: "配置中",
        completed: "完成",
        assistantName: "名称",
        assistantDescription: "描述",
        assistantStatus: "Status",
        createAssistant: "创建新的Madsys",
        deleteAssistant: "是否确认删除Madsys，删除Madsys之后其KVCache也会被同步清理掉哦~",
    },
    config:{
        title:'配置你的Madsys',
        ...
        createAssistant:'Madsys创建成功，点击build按钮开始构建KVCache',
    },
    build:{
        title:'构建日志',
        step1:'解析上传文件',
