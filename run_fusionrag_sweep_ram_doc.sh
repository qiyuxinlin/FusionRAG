...
RESULT_DIR="/home/shm/document/exp/FusionRAG/result/random_docs"       # 结果保存目录（CSV等）
...
RECALL_METHOD="random_docs"       # 召回方法: bge, random, repeat_self, fixed_doc, random_text, bge_shuffled, random_docs
