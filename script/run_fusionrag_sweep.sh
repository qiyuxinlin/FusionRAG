...
RESULT_DIR="/home/shm/document/exp/FusionRAG/result/bge_again"       # 结果保存目录（CSV等）
...
# 数据配置
DATA_PATH="./data/result_reflect.json" # result_reflect.json | 2wikimqa_reflect.json  result_reflect_merged.json 
